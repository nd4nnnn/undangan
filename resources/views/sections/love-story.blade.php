<div class="relative z-10 w-full px-3 py-4 pb-8 flex flex-col items-center">
    ...
    <h2 class="text-3xl sm:text-4xl text-maroon text-center mb-6 font-script-wedding tracking-wide">
        Our Love Story
    </h2>

    <!-- TIMELINE CONTAINER -->
    <div class="relative border-l-2 border-gold/50 ml-4 sm:ml-5 space-y-5 text-left w-full max-w-sm">
